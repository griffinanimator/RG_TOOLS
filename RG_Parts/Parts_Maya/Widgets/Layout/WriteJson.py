...
tmpDict['fkcontrol'] = ('ctrl_hip', 'ctrl_knee', 'ctrl_ankle', 'ctrl_ball', 'ctrl_toe')
...
tmpDict['jointnames'] = ('jnt_hip', 'jnt_spine1', 'jnt_spine2', 'jnt_spine3', 'jnt_spine4')
tmpDict['pjntnames'] = (['pjnt_hip', 'pjnt_hipEnd'], ['pjnt_spine1', 'pjnt_spine1End'], ['pjnt_spine2', 'pjnt_spine2End'], ['pjnt_spine3', 'pjnt_spine3End'], ['pjnt_spine4', 'pjnt_spine4End'])
tmpDict['fkcontrols'] = ('ctrl_s_hip', 'ctrl_s_spine1', 'ctrl_s_spine2', 'ctrl_s_spine3', 'ctrl_s_spine4')
tmpDict['partcontrols'] = (['pctrl_hip', 'pctrl_hipEnd'], ['pctrl_spine1', 'pctrl_spine1End'], ['pctrl_spine2', 'pctrl_spine2End'], ['pctrl_spine3', 'pctrl_spine3End'], ['pctrl_spine4', 'pctrl_spine4End'])
