...
class Create_Finger:
    ...
    def install(self, *args):
        ...
        fkControls = []
        for i in range(len(self.jnt_info['rigJnts'])-1):
            ...
            if i==0:
                ...
                fkControl = part_utils.setupControlObject("FingerControl.ma", ctrlName, ctrlAttrs, ctrlPos, os.environ['Parts_Maya_Controls'])          
            else:
                ctrlAttrs = []
                ctrlAttrs.append('stretch')
                fkControl = part_utils.setupControlObject("FingerControl.ma", ctrlName, ctrlAttrs, ctrlPos, os.environ['Parts_Maya_Controls'])
